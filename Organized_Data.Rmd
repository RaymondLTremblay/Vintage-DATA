...
This Rmd is to learn how to format the data prior to analyses.  The data are collected from the Karn and Penrose paper, in the same structure they are present in the paper, for analysis they needed to be wrangled for effective analysis in R and RStudio.
